...
// Companies
aboutRouter.route("/companies").get(getAllCompanies);
aboutRouter.route("/companies/add").post(verifyAdminJWT, upload.single("image"), addCompany);
aboutRouter.route("/companies/update/:companyId").put(verifyAdminJWT, upload.single("image"), updateCompany);
aboutRouter.route("/companies/delete/:companyId").delete(verifyAdminJWT, deleteCompany);
